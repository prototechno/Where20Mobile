...
Geolocation.prototype.watchPosition = function(successCallback, errorCallback, options)
{
  ...
  this.listeners.push( {"success" : successCallback, "fail" : errorCallback });
  
  var key = this.listeners.length - 1;
 ...
 *
 */	
Geolocation.prototype.success = function(key, lat, lng, acc, alt, altacc, head, vel)
{
  this.listeners[key].success(new Position(lat, lng, acc, alt, altacc, head, vel));
}
