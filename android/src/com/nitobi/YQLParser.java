...
{     
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) {
        ...
        if (localName.equalsIgnoreCase("result")) {
                ...
                this.currentLon = 0;
                this.currentPlace = null;
                this.currentGeo.lat = 0;
                this.currentGeo.lng = 0;
        }
    }
        ...
        if (localName.equalsIgnoreCase("longitude"))
        {
            if (this.inResult == true){
                ...
                if (this.currentLat != 0.0) {
                	this.currentGeo.lat = this.currentLat;
                	this.currentGeo.lng = this.currentLon;
                	if (this.currentPlace.length() > 0) {
                		Place obj = new Place(this.currentPlace);
                		obj.geo.lat = this.currentGeo.lat;
                		obj.geo.lng = this.currentGeo.lng;
                		this.places.add(obj);
                	}
                }
            } 
